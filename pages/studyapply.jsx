      ...
      <div style={{ margin: "50px" }}>
        ...
        <div style={{ marginTop: "20px" }}>
          ...
          <Text style={{ fontSize: "15px" }}>
            스터디 모집날짜 : {selectedStudy.meetingDate} (
            {selectedStudy.startTime} ~ {selectedStudy.endTime})
          </Text>
          {selectedStudy.userId !== myInfo.id ? (
            <Button style={{ marginLeft: "30px" }} onClick={onApplyBtn}>
              스터디 신청
            </Button>
          ) : (
            ""
        ...
        <div>
          ...
          <List
            ...
            renderItem={comment => (
              <List.Item
                actions={[
                  <a key="commentDate">{comment.createdDate}</a>,
                  <Button
                    type="danger"
                    id={comment.id}
                    key="deleteBtn"
              ...
              >
                <List.Item.Meta
                  avatar={<Avatar>{comment.name}</Avatar>}
          ...
          <Comment
            avatar={
              <Avatar style={{ backgroundColor: "red" }}>{myInfo.name}</Avatar>
            }
            content={
              <Editor
