...
function logInAPI(loginData) {
  ...
  return axios__WEBPACK_IMPORTED_MODULE_3___default.a.post("http://swot.devdogs.kr:8080/api/auth/signin", form).then(function (response) {
    ...
    var result = _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_1___default()(response, null, 2);

    var tokens = {
      refreshToken: result.FormData.refreshToken,
      accessToken: result.FormData.accessToken
    };
...
//# sourceMappingURL=_app.js.8f4e51d7b7c2bd575c5a.hot-update.js.map